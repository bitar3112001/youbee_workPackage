...
// node_modules/@swimlane/ngx-charts/fesm2015/swimlane-ngx-charts.mjs
...
var BaseChartComponent = class {
  ...
  bindWindowResizeEvent() {
    ...
    const source = (0, import_rxjs.fromEvent)(window, "resize");
    const subscription = source.pipe((0, import_operators.debounceTime)(200)).subscribe((e) => {
      this.update();
      if (this.cd) {
        this.cd.markForCheck();
      }
